...
const UUID = process.env.UUID || 'f5e90d9f-be9f-4f5d-9ff7-b9b91998547f'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'chore.nre4.dpdns.org';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYjczNmMwM2M5Yjk3MDdlMWU2N2I4ODExMWU2OWViZjMiLCJ0IjoiMmI3Y2ZhNmMtMDczZS00NjZiLWEzNjgtYTFkNDViYzA0N2U2IiwicyI6IlpESXdZbVl4TXpZdE9UaGlOUzAwWmpkakxXRm1NalV0TUdKa1pqWmlaakU0WXpBeCJ9';
const CFIP = process.env.CFIP || 'cersanayna.com';
const NAME = process.env.NAME || 'Choreo0514';
